...
export namespace FxOrmDML {
    export type KnexQueryBuilder = FxOrmTypeHelpers.ReturnType<KnexInstance['queryBuilder']>;

    export type BeforeQueryItem = (
        builer: KnexQueryBuilder,
        ctx: { dml: DMLDialect, knex: KnexInstance }
    ) => typeof builer | void

    export declare class DMLDialect<CONN_TYPE = any> extends FxOrmDXL.DXLDialect<CONN_TYPE> {
        find: {
            <T = Fibjs.AnyObject[]>(
                collection: string,
                opts?: {
