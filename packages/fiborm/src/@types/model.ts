...
export namespace FxOrmModel {
    export interface Class_ModelDefinitionOptions {
    ...
    export type Class_ModelConstructOptions = FxOrmTypeHelpers.ConstructorParams<typeof FxOrmModel.Class_Model>[0]
    export type ModelProperty = FxOrmProperty.Class_Property<Class_Model['propertyContext']>

    export declare class Class_Model extends FxOrmQueries.Class_QueryBuilder {
        name: string
        collection: string
     ...
     */
    export declare class Class_MergeModel extends Class_Model {
        /**
         * @description association name
         */
        name: string
