...
export declare class Class_ORM<ConnType = any> {
     ...
     */
    static parseHQL(sql: string, opts?: {
        models?: {
            [k: string]: FxOrmModel.Class_Model;
        };
    }): FxOrmQueries.HqLNormalizer;
    constructor(driver: FxDbDriverNS.Driver<ConnType> | string | FxDbDriverNS.ConnectionInputArgs, opts?: {
    ...
    readonly customPropertyTypes: {
        [k: string]: FxOrmProperty.CustomPropertyType;
    };
