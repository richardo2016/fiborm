...
export declare namespace FxOrmTypeHelpers {
    ...
    type FuncReturnArrayOrItEleViaArgIdx0<FUNC> = FUNC extends (arg0: infer ARG, ...args: infer OTHERS) => infer RTN ? ({
        (arg0: FlattenIfArray<ARG>[], ...args: OTHERS): RTN[];
        (arg0: FlattenIfArray<ARG>, ...args: OTHERS): RTN;
    }) : never;
    type MergeToFunctionArgOption0<FUNC, MERGED> = FUNC extends (arg0: infer ARG, ...args: infer OTHERS) => infer RTN ? (arg0: ARG & MERGED, ...args: OTHERS) => RTN : never;
    type FuncReturnArrayOrItEleViaArgIdx1<FUNC> = FUNC extends (arg0: infer ARG0, arg1: infer ARG, ...args: infer OTHERS) => infer RTN ? ({
