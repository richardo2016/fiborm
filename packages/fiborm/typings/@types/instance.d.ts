...
export declare namespace FxOrmInstance {
    class Class_Instance {
        ...
        readonly $refs: {
            [k: string]: FxOrmInstance.Class_Instance | any;
        };
         ...
         */
        constructor(model: FxOrmModel.Class_Model, input?: Fibjs.AnyObject);
         ...
         */
        $get: FxOrmTypeHelpers.FuncReturnArrayOrItEleViaArgIdx0<(fieldName: string) => Fibjs.AnyObject>;
        /**
         * @description
         ...
         */
        $getRef: FxOrmTypeHelpers.FuncReturnArrayOrItEleViaArgIdx0<(fieldName: string, opts?: FxOrmTypeHelpers.FirstParameter<FxOrmModel.Class_Model['find']>) => Class_Instance>;
        /**
         *
         ...
         */
        $hasRef: (refName: string, dataset?: FxOrmTypeHelpers.ItOrListOfIt<Fibjs.AnyObject | FxOrmInstance.Class_Instance>) => {
            /**
        ...
        $save: (kvs?: Fibjs.AnyObject, options?: {
            dml?: FxOrmDML.DMLDialect;
        }) => this;
        $saveRef: FxOrmTypeHelpers.FuncReturnArrayOrItEleViaArgIdx1<(refName: string, dataset: Fibjs.AnyObject | FxOrmInstance.Class_Instance) => Class_Instance>;
        /**
