...
export interface KnexInstance<TRecord extends {} = any, TResult = any[]>
  extends KnexNS.QueryInterface<TRecord, TResult>, Class_EventEmitter {
  <TRecord2 = TRecord, TResult2 = DeferredKeySelection<TRecord2, never>[]>(
    tableName?: KnexNS.TableDescriptor | KnexNS.AliasDict
  ): KnexNS.QueryBuilder<TRecord2, TResult2>;
  VERSION: string;
  __knex__: string;

  raw: KnexNS.RawBuilder<TRecord>;

  transactionProvider(
    config?: any
  ): () => Promise<KnexNS.Transaction>;
  transaction(
    transactionScope?: null,
    config?: any
  ): Promise<KnexNS.Transaction>;
  transaction<T>(
    transactionScope: (trx: KnexNS.Transaction) => Promise<T> | Promise<T> | void,
    config?: any
  ): Promise<T>;
  initialize(config?: KnexNS.Config): void;
  destroy(callback: Function): void;
  destroy(): Promise<void>;
  batchInsert(
    tableName: KnexNS.TableDescriptor,
    data: any[],
    chunkSize?: number
  ): KnexNS.QueryBuilder<TRecord, {}>;
  schema: KnexNS.SchemaBuilder;
  queryBuilder<TRecord2 = TRecord, TResult2 = TResult>(): KnexNS.QueryBuilder<
    TRecord2,
    TResult2
  >;

  client: any;
  migrate: KnexNS.Migrator;
  seed: KnexNS.Seeder;
  fn: KnexNS.FunctionHelper;
  ref: KnexNS.RefBuilder;
}

export type IGetKnex = {
  <TRecord = any, TResult = unknown[]>(
    config: KnexNS.Config | string
  ): KnexInstance<TRecord, TResult>
};

export declare namespace KnexNS {
  //
  // Utility Types
  //
  ...
  interface ValueDict extends Dict<Value | KnexNS.QueryBuilder> {}
  interface AliasDict extends Dict<string> {}

  type ColumnDescriptor<TRecord, TResult> =
    | string
    | KnexNS.Raw
    | KnexNS.QueryBuilder<TRecord, TResult>
    | Dict<string>;
  ...
  type TableDescriptor = string | KnexNS.Raw | KnexNS.QueryBuilder;
  ...
  interface AssymetricAggregation<TRecord = any, TResult = unknown[], TValue = any> {
    ...
    <
      TAliases extends {} = Record<string, string | string[] | KnexNS.Raw>,
      TResult2 = AggregationQueryResult<TResult, {[k in keyof TAliases]?: TValue}>
    >(aliases: TAliases): QueryBuilder<TRecord, TResult2>;
    <TResult2 = AggregationQueryResult<TResult, Dict<TValue>>>(
      ...columnNames: Array<Record<string, string | string[] | KnexNS.Raw> | KnexNS.Raw | string>
    ): QueryBuilder<TRecord, TResult2>;
  }
  ...
  interface Transaction<TRecord extends {} = any, TResult = any>
    extends KnexInstance<TRecord, TResult> {
  ...
  class QueryBuilder {
    static extend(
      ...
      fn: <TRecord extends {} = any, TResult = unknown[]>(
        this: KnexInstance<TRecord, TResult>,
        ...args: any[]
      ) => QueryBuilder<TRecord, TResult>
    ): void;
  }
