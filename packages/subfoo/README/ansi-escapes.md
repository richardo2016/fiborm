## require('@fibjs-mono-group/subfoo').ansiEscapes

<br>

`require('@fibjs-mono-group/subfoo').ansiEscapes` is migration from https://github.com/sindresorhus/ansi-escapes, for fibjs.
...
```
$ npm install @fibjs-mono-group/subfoo
```

## Usage

```js
import { ansiEscapes } from '@fibjs-mono-group/subfoo';
